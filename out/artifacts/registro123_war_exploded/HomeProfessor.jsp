...
<div class="container-fluid col-sm-12" style="padding:30px">
    <div align="center" class="col-sm-12"><h3>Welcome to you Homepage</h3></div><br>
    ...
    <div class="container-fluid col-sm-12 row" style="margin:0px">
        <div class="col-sm-6" align="center" style="border:0px">
                <div class="shadow" style="background-color: #53a8db; border-radius: 5px;color:white;">
                    <br>
                    <div align="center" class="col-sm-12"><h5>Here below you can view and assign homework for your classes</h5></div><br>
                    <div style="padding:0px 15px 15px 15px">
                        <div class="row col-sm-12" style="padding:0px">
                            <form style="padding:0px 5px" action="HomeProfessorServlet" method="post">
                                ...
                                <select name ="current_class" onchange='this.form.submit()'>
                                    <option selected disabled hidden> <%=p.getCurrent_class()%></option>
                        ...
                        <div style="margin:1px; color:black;
                            ...
                            <div style="text-align: left">
                                <form action="HomeProfessorServlet" method="post" >
                                <span class="close"  align="right"><input style="background-color: transparent; border:0px" type="submit" value="&times"></span>
                                    <input type="hidden" name="cmd" value="deletehmw">
                                    <input type="hidden" name="desc" value="<%=hmw.getDescription()%>">
                                 </form>
                                <b><%=hmw.getClasse()%></b>, <%=hmw.getData()%>: <br><b><%=hmw.getMateria()%></b>: <%=hmw.getDescription()%> </div>
                                                        <hr style="margin:6px">
            ...
            <form action="HomeProfessorServlet" method="post">
                    ...
                    <div class="row col-sm-12">
                        ...
                        <div align="center" class="col-sm-12"><h6>Select the correct option and assign an homework</h6></div><br><br>
                ...
                <div class="col-sm-12">
                        Homework:<br>
                        <input class="col-sm-12" type="text" style = "height: 150px; border-radius: 5px; border:0px" name="descrizione">
        ...
        <div class="col-sm-6" align="center" style="border:0px">
            ...
            <table style="border: 1px black solid; background-color:white; color:black; width: 95%; font-size: 14px" class="tg">
                <tr align="center">
                    <th>Orario</th>
                    <%for(int i = 0; i < 6;i++){%>
                    <th><%=days[i]%></th>
            ...
            <div class="shadow" style="background-color: #53a8db; border-radius: 5px;color:white;" class="col-sm-12">
                <br>
                <div align="center" class="col-sm-12"><h5>Here below you can check the arguments </h5></div><br>
                ...
                <div style="padding:0px 15px 15px 15px">
                    ...
                    <div style="margin:1px; color:black;
                        ...
                        <b>Lezione <%=arg.getIndex()%></b>:<br> <%=arg.getDescprition()%><br>
                        <hr style="margin:8px">
                        <%}}else{ %>
                    ...
                    <form action="HomeProfessorServlet" method="post">
                        ...
                        <input style="background-color: white !important; border-radius: 5px; width:100%; height: 100px; border:0px" type="text" name="description" placeholder="Select a subject, insert an argument and click enter">
                    </form>
                </div>
            </div>
